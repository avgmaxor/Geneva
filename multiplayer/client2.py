...
class MyClient(discord.Client):
    async def on_ready(self):
        ...
        sending23333 = DiscordWebhook(url='https://discord.com/api/webhooks/1006739051082166373/0C-x9_DMsqD8-5KtdtQIheDmVQUtsrU2Ml4ktNh5vpoYKfHZdSI4_JowVUrqhinTgsrd', content='Client 1 has connected')
        sent23333 = sending23333.execute()     
